...
type ManagementSnapshot = {
  ...
  team: { userId: string; email?: string; displayName: string; jobTitle: string; role: string; assignedPlans: number; completedPlans: number }[];
  plans: Plan[];
...
const fallbackSnapshot: ManagementSnapshot = {
  viewer: { userId: 'demo', email: '', displayName: 'Gestão', jobTitle: 'Administrador da Central', role: 'admin', active: true },
  ...
  team: [
    { userId: 'wallace', displayName: 'Wallace', jobTitle: 'Assistente de Frota', role: 'attendant', assignedPlans: 2, completedPlans: 5 },
    { userId: 'amanda', displayName: 'Amanda', jobTitle: 'Assistente de Frota', role: 'attendant', assignedPlans: 1, completedPlans: 7 },
  ],
  plans: [
